...
/**
 * Created by heweizong on 2018/5/9.
 */

public class LinearSmoothScroller extends DRecyclerView.SmoothScroller {
     ...
     */
    protected void updateActionForInterimTarget(DRecyclerView.SmoothScroller.Action action) {
    ...
    public int calculateDyToMakeVisible(View view, int snapPreference) {
        final DRecyclerView.LayoutManager layoutManager = getLayoutManager();
    ...
    public PointF computeScrollVectorForPosition(int targetPosition) {
        DRecyclerView.LayoutManager layoutManager = getLayoutManager();
